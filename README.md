...
- `ANTHROPIC_API_KEY`: Required for AI-powered content analysis and flash card generation
...
- `@ai-sdk/anthropic`: Anthropic integration for content analysis and generation
